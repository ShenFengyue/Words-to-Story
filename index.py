...
def _easter_egg_shenzhe_stream():
    ...
    msg = """我是申哲，一个喜欢折腾新鲜事物的人。

平时对心理学、AI、科技这些领域比较感兴趣，也喜欢观察人与人之间有趣的互动。相比把人生过成一条固定路线，我更喜欢保持好奇，体验不同的可能，认识不同的人。

性格上比较独立，也比较直接，喜欢有想法、有深度的交流。不喜欢无意义的社交，但很享受和有趣的人聊到深夜。

目前正在探索自己的方向，也在不断尝试新的可能。人生信条是：连接人群，创造价值。"""
